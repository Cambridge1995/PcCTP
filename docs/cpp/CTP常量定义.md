...
| 名称                | 宏定义                   | 常量  |
| :------------------ | :----------------------- | :---- |
| ^\d{8}*zz*\d{4}     | `THOST_FTDC_CUFN_CUFN_O` | `'O'` |
...
| 名称                      | 宏定义                   | 常量  |
| :------------------------ | :----------------------- | :---- |
| ^\d{8}*dl*\d{3}           | `THOST_FTDC_DUFN_DUFN_O` | `'O'` |
...
| 名称                                | 宏定义                   | 常量  |
| :---------------------------------- | :----------------------- | :---- |
| ^\d{4}*\d{8}*\d{8}_DailyFundChg     | `THOST_FTDC_SUFN_SUFN_O` | `'O'` |
| ^\d{4}*\d{8}*\d{8}_Trade            | `THOST_FTDC_SUFN_SUFN_T` | `'T'` |
| ^\d{4}*\d{8}*\d{8}_SettlementDetail | `THOST_FTDC_SUFN_SUFN_P` | `'P'` |
| ^\d{4}*\d{8}*\d{8}_Capital          | `THOST_FTDC_SUFN_SUFN_F` | `'F'` |
...
| 名称                                        | 宏定义                    | 常量  |
| :------------------------------------------ | :------------------------ | :---- |
| ^\d{4}*SG\d{1}*\d{8}_\d{1}_Trade            | `THOST_FTDC_CFUFN_SUFN_T` | `'T'` |
| ^\d{4}*SG\d{1}*\d{8}_\d{1}_SettlementDetail | `THOST_FTDC_CFUFN_SUFN_P` | `'P'` |
| ^\d{4}*SG\d{1}*\d{8}_\d{1}_Capital          | `THOST_FTDC_CFUFN_SUFN_F` | `'F'` |
| ^\d{4}*SG\d{1}*\d{8}_\d{1}_OptionExec       | `THOST_FTDC_CFUFN_SUFN_S` | `'S'` |
